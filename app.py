    ...
    if not st.session_state.roster:
        ...
        with st.spinner("Fetching data..."):
            ...
            for player in roster:
                ...
                player['points'] = historical_points  # projections skipped for stability

            if unmatched:
                st.warning(f"No data for: {', '.join(unmatched)}")

            # Optimization with strict no-duplicate
            ...
            def optimize(players, slots, eligible):
                ...
                # Strict global constraint: each player used in at most ONE slot
